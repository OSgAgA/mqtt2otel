...
namespace mqtt2otel.Stores
{
    ...
    public class DataStores : IDataStores
    {
        ...
        /// </summary>
        public ISignalStore SignalStore { get; private set; }
        ...
        /// </summary>
        public ILoggerStore LoggerStore { get; private set; }
        ...
        public DataStores(ISignalStore signalStore, ILoggerStore loggerStore)
        {
