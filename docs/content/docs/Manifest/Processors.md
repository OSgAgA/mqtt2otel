...
1. **General data**
   ...
   Here you can give your processor a name and a desciption. Additionally you can define a default otel connection to be used inside the processor.
...
| OtelScope {{< version value="beta">}}                         | The (optional) name of the instrumentation scope to be used.                                                              | 
...
| Mqtt                                                          | A section containing mqtt relevant parameters. [{{< importFromLabel >}}](organize)                                        |           
| Otel                                                          | A section containint open telemetry relevant parameters. [{{< importFromLabel >}}](organize)                              |   
...
| Subscriptions         | A list of [subscriptions](../subscription/#configure-subscriptions) to which the processor will subscribe. [{{< importFromLabel >}}](organize)             |
...
| Description                                                                              | An optional description.                                                                                                                                                  |
| Attributes                                                                               | A list of otel attributes that will be added to the otel signal. [{{< embeddedExpressionLabel >}}](/docs/expressions/topicparsing/#topic-parsing)                         |
| TopicAttributes {{< version value="1.1">}}                                               | The (optional) [TopicAttribute expression](/docs/expressions/topicparsing/#the-topicattribute-syntax) that maps topics to attributes.                                     |  
| CreateAttributesFromUserProperties {{< version value="1.1">}}                            | A value indicating, whether attributes should be created for all mqtt user attributes. Leave null to use parent settings.                                                 |
...
| OtelScope {{< version value="beta">}}                                                    | The (optional) name of the instrumentation scope to be used.                                                                                                              | 
| Metrics                                                                                  | An optional list of `Metrics` that will describe how the payload of a subscription message will be parsed into an otel metric signal. [{{< importFromLabel >}}](organize) | 
| Logs                                                                                     | An optional list of `Logs` that will describe how the payload of a subscription message will be parsed into an otel log message. [{{< importFromLabel >}}](organize)      | 
...
| Parameter                                                                                | Description                                                                                                                                                                |
|------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Name                                                                                     | The name of the created metric that will be send to the open telemetry endpoint. [{{< embeddedExpressionLabel >}}](/docs/expressions/topicparsing/#topic-parsing)          |
| Description                                                                              | The optional description that will be send to the open telemetry endpoint. [{{< embeddedExpressionLabel >}}](/docs/expressions/topicparsing/#topic-parsing)                |
| Attributes                                                                               | A list of otel attributes that will be added to the otel metric. [{{< embeddedExpressionLabel >}}](/docs/expressions/topicparsing/#topic-parsing)                          |
| TopicAttributes {{< version value="1.1">}}                                               | The (optional) [TopicAttribute expression](/docs/expressions/topicparsing/#the-topicattribute-syntax) that maps topics to attributes.                                      | 
| CreateAttributesFromUserProperties {{< version value="1.1">}}                            | A value indicating, whether attributes should be created for all mqtt user attributes. Leave null to use parent settings.                                                  |
...
| Unit                                                                                     | The optional unit that will be sent to the open telemetry endpoint as part of the metric. [{{< embeddedExpressionLabel >}}](/docs/expressions/topicparsing/#topic-parsing) | 
| ValueConverter {{< version value="1.1">}}                                                | The optional converter pattern, that will be used to convert a value. See [Converter](/docs/expressions/converter-and-formatter).                                          | 
| NameFormatter {{< version value="1.1">}}                                                 | The optional formatter pattern that will be used to format the name of the signal. See [Converter](/docs/expressions/converter-and-formatter).                             | 
| ParseAs {{< version value="1.1">}}                                                       | This optional parameter tells the processor to automaticall detect the signals based on the payload type. Available values: Json and XML. See [ParseAs](#parseas).         | 
| Actions {{< version value="1.1">}}                                                       | This optional parameter provides conditional actions that can be applied to a signal. See [Actions](/docs/expressions/actions).                                            | 
| Value                                                                                    | The value of the metric. Must be of type `SignalDataType`. [{{< expressionLabel >}}](/docs/expressions/#expressions)                                                       | 
...
| Attributes                                                                               | A list of otel attributes that will be added to the otel log entry. [{{< embeddedExpressionLabel >}}](/docs/expressions/topicparsing/#topic-parsing)                                          |
| CreateAttributesFromUserProperties {{< version value="1.1">}}                            | A value indicating, whether attributes should be created for all mqtt user attributes. Leave null to use parent settings.                                                                     |
...
| Filter                                                                                   | Defines the filter expression that will be applied if the `PayloadType` is set to `Text`. [{{< expressionLabel >}}](/docs/expressions/#expressions)                                           | 
