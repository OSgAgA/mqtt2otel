...
| Transform                          | A [Transform](Transform) expression that will be applied to the message before it is send to a processor     |
...
| Transform                          | A [Transform](Transform) expression that will be applied to the message before it is send to a processor. Can be overriden in a subscription. |
